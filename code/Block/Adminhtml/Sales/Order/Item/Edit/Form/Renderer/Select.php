...
class DigitalSession_Mbdt_Block_Adminhtml_Sales_Order_Item_Edit_Form_Renderer_Select
    extends Mage_Catalog_Block_Product_View_Options_Type_Select
{
    ...
    public function getValuesHtml()
    {
        ...
        $configValue = $this->helper('digitalsession_mbdt')->getItemOptionValueById($this->getOption()->getId());;
        ...
        $disableString = ($isDisabled === true) ? ' disabled="true" ' : '';
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input type="' . $type . '" class="' . $class . ' ' . $require
                    ...
                    . '<span class="label"><label
                     for="options_' . $_option->getId() . '_' . $count . '">'
